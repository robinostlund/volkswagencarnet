...
for vehicle in vehicles:
    ...
    print(' AdBlue: %s' % vehicle.adblue_level_supported)
    print(' Window Heater: %s' % vehicle.window_heater_supported)
    print(' Charging time left: %s' % vehicle.charging_time_left_supported)
    print(' Windows: %s' % vehicle.window_supported)
    print(' Door Locked: %s' % vehicle.door_locked_supported)
    print(' Trunk Locked: %s' % vehicle.trunk_locked_supported)
    print(' Electric Range: %s' % vehicle.electric_range_supported)
    print(' Combustion Range: %s' % vehicle.combustion_range_supported)
    print(' Combined Range: %s' % vehicle.combined_range_supported)
    print(' Total Range: %s' % vehicle.total_range_supported)
    print(' Primary Engine Range: %s' % vehicle.primary_engine_range_supported)
    print(' Fuel Range: %s' % vehicle.fuel_range_supported)
    print(' CNG Range: %s' % vehicle.cng_range_supported)
    print(' Battery Range: %s' % vehicle.battery_range_supported)
    print(' Combustion Engine Heating: %s' % vehicle.combustion_engine_heating_supported)

    print('Vehicle information:')
    print(' Distance: %s' % vehicle.distance)
    print(' Range: %s' % vehicle.range)
    ...
    print(' AdBlue Level: %s' % vehicle.adblue_level)
    print(' Fuel Level: %s' % vehicle.fuel_level)
    print(' Electric Range: %s' % vehicle.electric_range)
    print(' Combustion Range: %s' % vehicle.combustion_range)
    print(' Combined Range: %s' % vehicle.combined_range)
    print(' Total Range: %s' % vehicle.total_range)
    print(' Primary Engine Range: %s' % vehicle.primary_engine_range)
    print(' Fuel Range: %s' % vehicle.fuel_range)
    print(' CNG Range: %s' % vehicle.cng_range)
    print(' Battery Range: %s' % vehicle.battery_range)
