...
def create_instruments():
    ...
    return [
        ...
        Sensor(
            attr="trip_refuel_average_speed",
            name="Fuel trip average speed",
            icon="mdi:speedometer",
            unit="km/h",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_average_electric_engine_consumption",
            name="Fuel trip average electric engine consumption",
            icon="mdi:car-battery",
            unit="kWh/100 km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_average_fuel_consumption",
            name="Fuel trip average fuel consumption",
            icon="mdi:fuel",
            unit="l/100 km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_average_gas_consumption",
            name="Fuel trip average gas consumption",
            icon="mdi:gas-cylinder",
            unit="m3/100km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_duration",
            name="Fuel trip duration",
            icon="mdi:clock",
            unit="min",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_length",
            name="Fuel trip length",
            icon="mdi:map-marker-distance",
            unit="km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_recuperation",
            name="Fuel trip recuperation",
            icon="mdi:battery-plus",
            unit="kWh/100 km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_average_recuperation",
            name="Fuel trip average recuperation",
            icon="mdi:battery-plus",
            unit="kWh/100 km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_average_auxillary_consumption",
            name="Fuel trip average auxillary consumption",
            icon="mdi:flash",
            unit="kWh/100 km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_average_aux_consumer_consumption",
            name="Fuel trip average auxillary consumer consumption",
            icon="mdi:flash",
            unit="kWh/100 km",
            state_class=VWStateClass.MEASUREMENT,
        ),
        Sensor(
            attr="trip_refuel_total_electric_consumption",
            name="Fuel trip total electric consumption",
            icon="mdi:car-battery",
            unit="kWh/100 km",
            state_class=VWStateClass.MEASUREMENT,
        ),
